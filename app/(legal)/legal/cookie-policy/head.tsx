...
export default async function Head() {
  ...
  return (
    <>
      ...
      <link rel="canonical" href={`${WEBSITE_URL}/legal/cookie-policy`} />

      {/* <!-- Facebook Meta Tags --> */}
      <meta property="og:url" content={`${WEBSITE_URL}/legal/cookie-policy`} />
      <meta property="og:type" content="website" />
      <meta property="og:title" content={`Cookie Policy | ${title}`} />
      <meta
        property="og:image"
        content={`${
